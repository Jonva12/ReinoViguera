    ...
    <div class="col-lm-10">
      <div>
        ...
        <blockquote class="blockquote">
          <p>“Sus formas abrazan una parte del espacio construyendo un pequeño lugar dentro de otro lugar. Su arquitectura en el tiempo tal vez sea la suma de las reflexiones de las personas que hacen este lugar y de las que están de paso. Tal vez con el tiempo sea un lugar por el que pasar y en que poder pensar, descansar, soñar, amar, conversar, escuchar, declamar. De nuevo caminar Pero solo tal vez.”</p>
          <footer class="blockquote-footer">Jose Antonio Olarte. Reflexión 40.076</footer>
        </blockquote>
      </div>
    </div>
</div>
